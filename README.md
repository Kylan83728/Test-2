...
local Toggle = farmTab:CreateToggle({
   ...
   Callback = function(Value)
local args = {
    [1] = Vector3.new(-80.52310180664062, 595.4214477539062, 813.802001953125),
    [2] = "NewFireball"
}
...
game:GetService("ReplicatedStorage"):WaitForChild("jdskhfsIIIllliiIIIdchgdIiIIIlIlIli"):FireS"):FireServer(unpack(args))
task.wait(0.1) -- Pause
local args = {
